...
@endphp
  ...
  <!-- Content Wrapper. Contains page content -->
	 ...
	 <tr>
		...
		<td>
 <a href="{{ route('user.edit',$user->id) }} " class="btn btn-info" title="Edit Data"><i class="fa fa-pencil"></i> </a>
 <a href="{{ route('admin.user.view',$user->id) }}" class="btn btn-success" title="View" ><i class="fa fa-eye"></i></a>
 <a href="{{ route('admin.user.delete',$user->id) }} " class="btn btn-danger" title="Delete Data" id="delete">
