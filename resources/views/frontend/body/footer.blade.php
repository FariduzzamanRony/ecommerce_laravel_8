            ...
            <div class="container">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="widget widget-about">
                                <a href="demo1.html" class="logo-footer">
                                    <img src="{{ asset($header_section->header_logo) }}" alt="logo-footer" width="144"
                                        height="45" />
                                </a>
                ...
                @endif
                                    ...
                                    <div class="social-icons social-icons-colored">
                                        <a href="https://www.facebook.com/electrocapture2005" class="social-icon social-facebook w-icon-facebook"></a>
                ...
                <div class="footer-bottom">
                    <div class="footer-left">
                        <p class="copyright">Copyright © 2021 ElectroCapture All Rights Reserved.</p>
                    </div>
