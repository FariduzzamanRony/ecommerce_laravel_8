                ...
                <div class="container">
                    <ul class="breadcrumb bb-no">
                        ...
                        @if(session()->get('language') == 'others')
                          {{ $breadbrand->brand_name_others }}
                          @else
                          {{ $breadbrand->brand_name_en }}
                          @endif
                        </li>
                    </ul>
                </div>
            ...
            <div class="page-content mb-10">
                <div class="shop-default-banner shop-boxed-banner banner d-flex align-items-center mb-6"
                    ...
                    <div class="container banner-content">
                        <h4 class="banner-subtitle font-weight-bold">Chandelier-Crystal-Light</h4>
                        <h3 class="banner-title text-white text-uppercase font-weight-bolder ls-10">Laxury Product</h3>
