  ...
  <main class="main">
            ...
            <nav class="breadcrumb-nav">
                <div class="container">
                    <ul class="breadcrumb bb-no">
                        ...
                        <li><a href="https://electrocapture.com/shop">Shop</a></li>
                        <li>Fullwidth</li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="page-content mb-10">
             <!--   <div class="shop-default-banner shop-boxed-banner banner d-flex align-items-center mb-6"
                    style="background-image: url({{asset('frontend/assets/images/shop/banner2.jpg')}}); background-color: #ff4ebb;">
                    <div class="container banner-content">
                        ...
                        <a href="shop-banner-sidebar.html" class="btn btn-dark btn-rounded btn-icon-right">Shop 
