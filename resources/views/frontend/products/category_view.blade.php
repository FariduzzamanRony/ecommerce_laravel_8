...
<style>
  ...
  <main class="main">
            ...
            <nav class="breadcrumb-nav">
                <div class="container">
                    <ul class="breadcrumb bb-no">
                        ...
                        <li><a href="shop-banner-sidebar.html">Category</a></li>
                        <!-- <li>Fullwidth</li> -->
                    </ul>
                </div>
            </nav>
            ...
            <!--    <div class="shop-default-banner shop-boxed-banner banner d-flex align-items-center mb-6"
                    style="background-image: url({{asset('frontend/assets/images/shop/asib.png')}}); background-color: #FFC74E;">
                    <div class="container banner-content">
                        <h4 class="banner-subtitle font-weight-bold">ElectroCapture </h4>
                        <h3 class="banner-title text-white text-uppercase font-weight-bolder ls-10">Latest New Product</h3>
                        <a href="https://electrocapture.com/shop" class="btn btn-dark btn-rounded btn-icon-right">Shop
